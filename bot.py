...
class QuizSystem:
    ...
    async def end_quiz(self):
        ...
        # 1. FIRST show quiz finished message
        embed = discord.Embed(
            title="🏆 **QUIZ FINISHED!** 🏆",
        ...
        try:
            ...
            try:
                ...
                await self.quiz_channel.send(f"⚠️ Reward error: {str(e)[:50]}")
                rewards_distributed = {}
            ...
            print(f"❌❌❌ CRITICAL ERROR in end_quiz: {e}")
            import traceback
            traceback.print_exc()
